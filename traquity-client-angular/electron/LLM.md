...
electron/
  ...
  ai/
    ...
    transaction-extraction/
      transaction-extraction.js the document-extraction usecase: the grammar generated from the literals the request
...
(`prompts/<usecase>/`, a `default.md` plus a `<modelKey>.md` for each model that measurably needs one), the grammar its answer decodes under
