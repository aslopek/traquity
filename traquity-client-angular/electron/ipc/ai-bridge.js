 ...
 *
 * `ai:extractTransaction` writes nothing to `traquity.config.json`: it validates the request and hands it on, and every decision about
 * models, prompts and grammars is made behind `extractTransaction`. A request the schema refuses goes to the log first, since a rejected
 * call carries no outcome to name the field in.
 *
