...
describe('catalogueEntries', () => {
  it('projects every catalogue entry to key, description, sizeBytes, license and requiredVram only', () => {
    expect(catalogueEntries()).toEqual(Object.values(CATALOGUE).map(({key, description, sizeBytes, license, requiredVram}) =>
