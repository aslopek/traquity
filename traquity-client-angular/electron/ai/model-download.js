...
/**
 * Downloads and verifies one model from Hugging Face into a picked directory. There is no signature to check here: GGUF weights
 * are not signed, so the pinned sha256 already baked into the catalogue is what a completed download is measured against.
 */
...
/**
 * The pinned download URL for a catalogue entry - built from this app's own copy of `repo`/`revision`/`file`.
 *
