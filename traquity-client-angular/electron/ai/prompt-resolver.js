 ...
 *
 * Layer 4 normally makes the resolution total, so only a hand-deleted packaged default leaves a usecase without a
 * prompt. Where no layer answers, no model is prompted.
 *
 * Which layer answered is part of the result: the failure mode of an override is forgetting it is there and
 * debugging the prompt that is not in use.
 */

/**
 * The usecases with a packaged prompt directory. A new one is a member here plus a directory beside the others.
 *
