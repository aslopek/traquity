/**
 * The native directory picker for choosing where a model download lands. `dialog` and the main window are injected, so this module is
 * exercisable without an Electron instance, and no dialog opens without a parent window to attach to and return a selection to.
 */
