...
/**
 * The securities this app knows, keyed by their ISIN. An ISIN identifies a security exactly, so a lookup that
 * misses means the security is genuinely unknown.
 */
